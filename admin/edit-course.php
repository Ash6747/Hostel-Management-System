...
if($stmt->execute()){
	echo"<script>alert('Course has been Updated successfully');
	window.location.href='manage-courses.php';</script>";
										...
										<form method="post" class="form-horizontal">
												...
												while($row=$res->fetch_object())
												{
													?>
																...
																<div class="col-sm-8">
																<input type="text"  name="cc" value="<?php echo $row->course_code;?>"  class="form-control" required> </div>
																</div>
															<div class="form-group">
