...
<head>
	...
	<title>Room Transfer Complaints</title>
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top:4%">Room Transfer Complaints</h2>
...
<td>
<a href="room-transfer_request.php?cid=<?php echo encrypt($row->id);?>" title="View Full Details"><i class="fa fa-desktop"></i></a>&nbsp;&nbsp;
</td>
										</tr>
									<?php
$cnt=$cnt+1;
