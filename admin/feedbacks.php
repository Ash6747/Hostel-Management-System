...
<td>
<a href="feedback-details.php?userPrn=<?php echo encrypt($row->userPrn);?>&&uid=<?php echo encrypt($row->userId);?>" title="View Full Details" target="blank"><i class="fa fa-desktop"></i></a>&nbsp;&nbsp;
</td>
										</tr>
									<?php
$cnt=$cnt+1;
