						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-primary">
									...
									<label class="col-sm-2 control-label"> Complaint Type <span class="text-danger">*</span></label>
									<div class="col-sm-8">
									...
									<!-- <div class="form-group">
									<label class="col-sm-2 control-label">Explain the Complaint<span class="text-danger">*</span></label>
									<div class="col-sm-8">
									...
									<div class="form-group">
                                        <label class="col-sm-2 control-label">Explain the Complaint<span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
                                        <textarea name="cdetails" id="cdetails"  class="form-control limitedText" oninput="validateInput(event)" maxlength="200" required></textarea>
									...
									<div class="form-group">
									<label class="col-sm-2 control-label">File (if any)<span class="text-danger">*</span></label>
									<div class="col-sm-8">
									<input type="file" accept=".pdf,image/*" name="image" id="image"  class="form-control" >
									</div>
									</div>
