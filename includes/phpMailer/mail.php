...
function attchMailNew($recipientName, $recipientEmail, $subject, $body, $altBody, $cc = null, $bcc = null, $attachment = null) {
    ...
    try {
        ...
        $mail->Username = 'ashishsatpute6747@gmail.com';       // SMTP username
        $mail->Password = 'nujmrlqoqomkncda';              // SMTP password
        $mail->SMTPSecure = 'tls';                            // Enable TLS encryption
        $mail->Port = 587;                                    // TCP port to connect to

        // Recipients
        $mail->setFrom('ashishsatpute6747@gmail.com', 'Stay Easy admin');   // Set the sender's email and name
...
function newMailOld($recipientName, $recipientEmail, $cc, $bcc, $subject, $body, $altBody){
    ...
    $mail->setFrom('ashishsatpute6747@gmail.com', 'Stay Easy admin');
    $mail->addAddress($recipientEmail, $recipientName);     // Add a recipient
    //$mail->addAddress('ellen@example.com');               // Name is optional
