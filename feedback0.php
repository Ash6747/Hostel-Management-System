...
<div class="col-sm-8">
<textarea name="feedback" id="feedback" oninput="validateInput(event)" maxlength="200"  class="form-control limitedText"></textarea>
...
<span class="text-muted charCount">200 characters remaining</span>
									...
									<!-- <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                        <textarea name="reason" id="limitedText" class="form-control" oninput="validateInput(event)" maxlength="200" required></textarea>
                                        <span id="error" class="error text-danger"></span>
                                        <span id="charCount" class="text-muted">200 characters remaining</span>
                                        </div>
                                    </div> -->

<div class="col-sm-6 col-sm-offset-4">
<button class="btn btn-primary sub" name="submit" type="submit">Submit</button>
<!-- <input type="submit" name="submit" id="sub" Value="Submit" class="btn btn-primary"> -->
</div>
</form>
<?php }} else {?>
